    ...
    <div class="flex h-screen font-sans">
        ...
        <div class="w-1/2 flex flex-col justify-center items-center px-10 bg-white">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4 w-full max-w-md">
                ...
                <x-primary-button class="w-full bg-blue-900 text-white py-3 rounded mt-2 hover:bg-blue-800">
                    Registrar
                </x-primary-button>
            </form>
        ...
        <div class="w-1/2 relative">
            <img src="{{ asset('img/bg/registrarse.jpg') }}" alt="Fondo Click & Save" class="w-full h-full object-cover" />
